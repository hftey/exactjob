...
$dbFileName = 'exactjob'.date('Ymd').'.sql.gz';

$dbFile = '/var/www/html/raymond/venzon/demo/exactjob/Backup/'.$dbFileName;
...
$upload = ftp_put($conn_id, "job/".$dbFileName, $dbFile, FTP_BINARY);
