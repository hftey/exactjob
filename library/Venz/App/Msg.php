...
class Venz_App_Msg
{
	...
	public function getMsg()
	{
		...
		if ($arrErrors){
			...
			{
				$msgString .= "<table><TR><TD valign=top width=40px><img src='/images/icons/IconAlert.png'></TD><TD>".$errMsg . "</TD></TR></table><BR>";
			}
		...
		if ($arrSuccess){
			...
			{
				$msgString .= "<table><TR><TD valign=top width=40px><img src='/images/icons/IconSuccess.gif'></TD><TD>".$sucMsg . "</TD></TR></table><BR>";
			}
		...
		if ($arrNotice){
			...
			{
				$msgString .= "<table><TR><TD valign=top width=40px><img src='/images/icons/IconWarning.png'></TD><TD>".$sucMsg . "</TD></TR></table><BR>";
			}
		...
		if ($arrInfo){
			...
			{
				$msgString .= "<table><TR><TD valign=top width=40px><img src='/images/icons/IconInfo.png'></TD><TD>".$sucMsg . "</TD></TR></table><BR>";
			}
	...
	public function getNotice()
	{
		...
		if ($arrNoticeErrors){
			...
			{
				$msgString .= "<div class=\"alert alert-danger\">&nbsp;".$errMsg . "</div>";
			}
		...
		if ($arrNoticeNotice){
			...
			{
				$msgString .= "<div class=\"alert alert-warning\">&nbsp;".$sucMsg . "</div>";
			}
