    ...
    class Venz_App_Display_Table
    {
        ...
        function render ()
        {
            ...
            if (strlen($this->attr['title']) > 0 || strlen($this->attr['export_excel']) > 0) {
                ...
                if ($this->rowcount > 0){
                    $r .=   " <TR>\n    ".
                            "  <TD class='report_title' align=left colspan='".
                                $maxcols . "'><table width=100% border=0 cellspacing=0 cellpadding=0><TR><TD  class='report_title' valign=middle>" . $this->attr['title'] . "</TD></TR><TR><TD valign=middle align=right width=20px>".$this->attr['export_excel']."</TD><TD valign=middle align=right width=20px>".$this->attr['export_pdf']."</TD></TR></TABLE></TD>\n".
                            " </TR>\n";
                }
                else{
                    $r .=   " <TR>\n    ".
