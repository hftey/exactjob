...
class Venz_App_Upload_Helper
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' =>  '/photo/upload/process', //$this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/photos/',
            'upload_url' => $this->get_full_url().'/photos/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
